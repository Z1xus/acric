	...
	<header class="bg-gray-800 py-4">
		<nav class="container mx-auto px-4">
			<ul class="flex justify-center space-x-6">
				<li>
					<a href="{base}/" class="text-blue-400 hover:text-purple-300 transition-colors">home</a>
				</li>
				<li>
					<a href="{base}/download" class="text-blue-400 hover:text-purple-300 transition-colors"
						>download</a
					>
				</li>
				<li>
					<a href="{base}/contact" class="text-blue-400 hover:text-purple-300 transition-colors"
						>contact</a
					>
				</li>
			</ul>
